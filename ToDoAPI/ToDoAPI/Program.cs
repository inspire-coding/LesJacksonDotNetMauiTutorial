...
app.MapPut("api/todo/", async (AppDbContext context, ToDo toDo) =>
{
    var toDoModel = await context.ToDos.FirstOrDefaultAsync(t => t.Id == toDo.Id);
...
app.MapDelete("api/todo/", async (AppDbContext context, int id) =>
{
